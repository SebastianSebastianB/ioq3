...
void CG_AddViewWeapon( playerState_t *ps ) {
	...
	hand.renderfx = RF_FIRST_PERSON | RF_MINLIGHT;  // Removed RF_DEPTHHACK to respect Z-buffer
...
/*
=================
CG_MissileHitWall_Poison

Identyczna kopia CG_MissileHitWall ale z nową nazwą.
Na początku działa identycznie jak normalna eksplozja.
=================
*/
void CG_MissileHitWall_Poison( int weapon, int clientNum, vec3_t origin, vec3_t dir, impactSound_t soundType ) {
	qhandle_t		mod;
	qhandle_t		mark;
	qhandle_t		shader;
	sfxHandle_t		sfx;
