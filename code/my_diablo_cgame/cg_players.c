...
static qboolean CG_PlayerShadow( centity_t *cent, float *shadowPlane ) {
	...
	*shadowPlane = 0;
	...
	// TEMPORARY FIX: Disable shadows for .world maps to prevent crash
	// TODO: Implement terrain-based shadow tracing for .world files
	if ( cg.world.worldName[0] != '\0' ) {
		// This is a .world map - BSP traces will crash
		return qfalse;
	}
